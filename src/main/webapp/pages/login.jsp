...
<head>
    ...
    <title>Pookie Login - Learning Log</title>
    <style>
        body {
            margin: 0;
...
<main class="page">
    <section class="card" aria-labelledby="login-title">
        ...
        <h1 id="login-title">Welcome back, cutie</h1>
        <p class="subtitle">Log in to your Learning Log and keep your streak glowing.</p>
        ...
        <p class="footer">New here? <a href="register">Create an account</a></p>
    </section>
</main>
</body>
</html>
